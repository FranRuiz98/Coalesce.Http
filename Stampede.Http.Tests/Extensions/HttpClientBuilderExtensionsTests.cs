...
namespace Stampede.Http.Tests.Extensions;
...
public class HttpClientBuilderExtensionsTests
{
    ...
    [Fact]
    public async Task AddStampedeHttp_RegistersPipelineCorrectly()
    {
        var services = new ServiceCollection();
        int backendCalls = 0;

        services.AddHttpClient("test").AddStampedeHttp()
    ...
    [Fact]
    public void AddStampedeHttp_ReturnsBuilder_ForChaining()
    {
        var services = new ServiceCollection();
        var builder = services.AddHttpClient("test");

        var result = builder.AddStampedeHttp();

        result.Should().BeSameAs(builder);
    }

    [Fact]
    public void AddStampedeHttp_AcceptsCacheOptionsConfigure()
    {
        var services = new ServiceCollection();

        var act = () => services
            .AddHttpClient("test")
            .AddStampedeHttp(o => o.DefaultTtl = TimeSpan.FromMinutes(10));

        act.Should().NotThrow();
    }

    [Fact]
    public async Task AddStampedeHttp_CacheHit_DoesNotReachCoalescer()
    {
    ...
    [Fact]
    public async Task AddStampedeHttp_CacheMiss_CoalescesIdenticalConcurrentRequests()
    {
    ...
    [Fact]
    public async Task AddStampedeHttp_WithMultipleClients_PipelinesAreIsolated()
    {
        var services = new ServiceCollection();
        int countA = 0, countB = 0;

        services.AddHttpClient("a").AddStampedeHttp()
            .ConfigurePrimaryHttpMessageHandler(() => new TestHandler(() =>
            {
        ...
        services.AddHttpClient("b").AddStampedeHttp()
            .ConfigurePrimaryHttpMessageHandler(() => new TestHandler(() =>
            {
    ...
    [Fact]
    public async Task AddStampedeHttp_CalledTwice_PipelineStillWorks()
    {
        var services = new ServiceCollection();
        int backendCalls = 0;
        var builder = services.AddHttpClient("test");

        builder.AddStampedeHttp();
        builder.AddStampedeHttp();
    ...
    [Fact]
    public void AddStampedeHttp_WithNullBuilder_Throws()
    {
        IHttpClientBuilder builder = null!;

        Action act = () => builder.AddStampedeHttp();
    ...
    public void UseDistributedCacheStore_WithoutPriorCacheRegistration_RegistersDistributedCacheStore()
    {
        ...
        // UseDistributedCacheStore without a prior AddStampedeHttp/AddCachingOnly
        services.AddHttpClient("test")
            .UseDistributedCacheStore();
    ...
    public void UseDistributedCacheStore_ReturnsBuilder_ForChaining()
    {
        ...
        var builder = services.AddHttpClient("test").AddStampedeHttp();
    ...
    [Fact]
    public async Task AddStampedeHttp_MultipleClients_CacheStoresAreIsolated()
    {
    ...
    [Fact]
    public async Task AddStampedeHttp_MultipleClients_DifferentCacheSettings_DoNotConflict()
    {
