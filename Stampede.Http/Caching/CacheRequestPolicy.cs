...
public static class CacheRequestPolicy
{
    ...
    /// </summary>
    public static readonly HttpRequestOptionsKey<bool> BypassCache = new("Stampede.Http.BypassCache");
    ...
    /// </summary>
    public static readonly HttpRequestOptionsKey<bool> ForceRevalidate = new("Stampede.Http.ForceRevalidate");
