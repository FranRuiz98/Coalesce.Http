...
/// </summary>
internal sealed partial class RequestCoalescer(IOptionsMonitor<CoalescerOptions> optionsMonitor, string clientName, StampedeHttpMetrics? metrics = null, ILogger<RequestCoalescer>? logger = null)
{
    ...
    /// </summary>
    internal RequestCoalescer(CoalescerOptions options, StampedeHttpMetrics? metrics = null, ILogger<RequestCoalescer>? logger = null)
